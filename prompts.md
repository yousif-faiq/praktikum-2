...
x86-64 system with the following properties:
  ...
  - CHAR_BIT = 8
  - All arithmetic is wrapping (no undefined behavior)
  - All right shifts on unsigned types are logical

Your task: determine the EXACT stdout output of the following C program.
